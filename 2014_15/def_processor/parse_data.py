...
with open('../main_data/14-15.csv', 'r') as main_file:
    ...
    with open('../def_result_files/names.csv', 'w') as fwd_file:
        fieldnames = ['playerId', 'gameweek', 'name', 'minutes-played', 'team', 'opponent','clean-sheet','goals-conceded', 'goals-scored', 'assists', 'yellow-cards', 'red-cards', 'bonus', 'total']
