...
df = pd.read_csv('../def_result_files/sorted_names.csv')

columns = ['mins-pm', 'team', 'opponent', 'cs-pm','conceded-pm', 'goals-pm', 'assists-pm', 'yellow-cards-pm', 'red-cards-pm', 'bonus-pm', 'current-form', 'total']
...
print new_df
new_df.to_csv('../def_result_files/def_data.csv', index=False)